...
// We validate if the user previously chose theme
if (selectedTheme) {
  // if the validation is fuilled, we ask what the issue was to know if we activated or deactivated the dark theme
